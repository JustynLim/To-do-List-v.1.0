...
######################################################################################################################################
    ...
    Heading = Label(app_root, text=f"HI {greet_user.upper()}",  font = "arial 20 bold", fg = "white", bg = "#9960D1")
...
######################################################################################################################################
    ...
    def delete_task():
        ...
        if selected_task is not None:
            ...
            try:
                cursor.execute("DELETE FROM TASK WHERE TASK_ID = ?", (del_task,))
                Connect.commit()
                load_tasks()
                #task_list.pop(index)
    ...
    # Task List box
    listbox = Listbox(frame1, font = "arial 12 bold", width = 80, height = 16, bg = "#9960D1", fg = "white", cursor = "hand2" , selectbackground = "black")
